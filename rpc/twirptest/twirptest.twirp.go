...
func NewHelloWorldProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	...
	serviceURL += baseServicePath(pathPrefix, "twirptest", "HelloWorld")
	urls := [1]string{
		serviceURL + "Hello",
	}
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest")
...
const HelloWorldPathPrefix = "/twirp/twirptest.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "twirptest.HelloWorld" {
...
func (s *helloWorldServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "twirptest", "HelloWorld")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x2f, 0x29, 0xcf, 0x2c, 0x2a, 0x28, 0x49, 0x2d, 0x2e, 0x41, 0xb0, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b,
	0xf2, 0x85, 0x38, 0xe1, 0x02, 0x4a, 0x2a, 0x5c, 0x1c, 0x1e, 0xa9, 0x39, 0x39, 0xf9, 0x41, 0xa9,
	...
	0x4b, 0x49, 0x6a, 0x05, 0x4c, 0x0d, 0x98, 0x6d, 0xe4, 0xc0, 0xc5, 0x05, 0x56, 0x10, 0x9e, 0x5f,
	0x94, 0x93, 0x22, 0x64, 0xc4, 0xc5, 0x0a, 0xe6, 0x09, 0x09, 0xeb, 0x21, 0xac, 0x86, 0x59, 0x23,
	0x25, 0x82, 0x29, 0x58, 0x5c, 0xe0, 0xc4, 0x1f, 0xc5, 0x8b, 0xe2, 0xe8, 0x24, 0x36, 0xb0, 0x5b,
	0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x21, 0x2e, 0xc5, 0x2d, 0xcc, 0x00, 0x00, 0x00,
}
